...
void QHexEdit::setDataHighlighted(int i, bool state)
{
    qHexEdit_p->setDataHighlighted(i, state);
}

void QHexEdit::setDataHighlighted(QList<uint> data, bool state)
{
    qHexEdit_p->setDataHighlighted(data, state);
}
